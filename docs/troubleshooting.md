...
5. PHY reference의 backend, profile, spec/DQ-map SHA-256, exact CA/DQ target, dimension 단위와 conversion을 확인합니다.
6. 패키지 상세의 MT/s, FSP, 온도 C, rail mV가 plan과 같은지 확인합니다.
