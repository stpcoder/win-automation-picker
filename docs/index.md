...
<div class="workflow-grid">
  <div class="workflow-card">
    ...
    <span><code>연속 녹화 시작</code> 후 실제 업무를 수행해 클릭, 입력, 키와 Windows UIA 요소를 한 번에 기록합니다.</span>
  </div>
  <div class="workflow-card">
    <strong>5. SEQ 연동</strong>
    <span>Test Sequence Generator의 검증 패키지를 PC/슬롯/CH별로 SK Commander 런처에 배정합니다.</span>
  </div>
  <div class="workflow-card">
...
5. 여러 PC/CH를 하나의 시험으로 관리한다면 [AE 캠페인 운영](rig-ftp/ae-campaign.md)을 따릅니다.
6. SEQ를 SK Commander로 배포한다면 [SEQ Generator와 SK Commander 연동](rig-ftp/seq-integration.md)을 따릅니다.
7. 문제가 생기면 [문제 해결](troubleshooting.md)을 확인합니다.
