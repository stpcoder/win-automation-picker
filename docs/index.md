...
<div class="workflow-grid">
  <div class="workflow-card">
    ...
    <span><code>Inspect</code>, <code>Click block</code>, <code>Type block</code>으로 Windows UIA 요소를 캡처합니다.</span>
  </div>
  <div class="workflow-card">
    <strong>2. 블록으로 설계</strong>
    <span><code>Build</code> 탭에서 반복, 조건, 모니터링 블록을 조합합니다.</span>
  </div>
  <div class="workflow-card">
    <strong>3. 실행/내보내기</strong>
    <span><code>Run once</code>, <code>Run rows</code>, <code>Export Python</code>으로 실행 가능한 흐름을 만듭니다.</span>
  </div>
  <div class="workflow-card">
