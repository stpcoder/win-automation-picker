...
![SEQ와 Scratch 검증이 완료된 AE Workbench](docs/assets/screenshots/01-ae-workbench.png)
...
- Test Sequence Generator의 `.rigseq.zip`을 재검증하고 PC/슬롯/CH별 SK Commander 런처에 배정합니다.
...
1. `AEWorkbench.exe > AE 작업대 > 새 매크로`를 누르거나 `WinAutomationPicker.exe`를 실행합니다.
...
6. master의 `PC / 슬롯 / CH별 실행표`에서 각 slave의 macro 또는 SEQ와 변수 값을 정하고 제출합니다.
...
- [SEQ Generator와 SK Commander 연동](https://stpcoder.github.io/win-automation-picker/rig-ftp/seq-integration/)
